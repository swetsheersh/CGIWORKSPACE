...
//		  WebDriver driver=new ChromeDriver(options);
		  try {
			  ...
			  Thread.sleep(2000);
			  test.createNode("Blank UserName and password");
			  ...
			  test.createNode("Blank password");
			...
			//geting webelement again due to refresh
			  ...
			  Thread.sleep(2000);
			  test.createNode("Blank UserName");
			  ...
			  test.createNode("Invalid UserName and password");
			...
			//geting webelement again due to refresh
			  ...
			  login.submit();
			  Thread.sleep(2000);
			  test.createNode("valid UserName and password");
